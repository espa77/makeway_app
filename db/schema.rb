...
ActiveRecord::Schema.define(version: 20161019140915) do
  ...
  add_index "assets", ["product_attribute_id"], name: "index_assets_on_product_attribute_id", using: :btree
  ...
  add_index "dimensions", ["height"], name: "index_dimensions_on_height", using: :btree
  add_index "dimensions", ["product_attribute_id"], name: "index_dimensions_on_product_attribute_id", using: :btree
  add_index "dimensions", ["weight"], name: "index_dimensions_on_weight", using: :btree
  add_index "dimensions", ["width"], name: "index_dimensions_on_width", using: :btree

  create_table "mkt_chn_data", force: :cascade do |t|
    t.integer  "product_attribute_id"
    t.string   "msrp"
  ...
  add_index "mkt_chn_data", ["product_attribute_id"], name: "index_mkt_chn_data_on_product_attribute_id", using: :btree
  ...
  create_table "spec_attributes", force: :cascade do |t|
  ...
  add_index "spec_attributes", ["specification_id"], name: "index_spec_attributes_on_specification_id", using: :btree

  create_table "specifications", force: :cascade do |t|
    t.integer  "mkt_chn_data_id"
    t.string   "purpose_attribute_set"
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
  end

  add_index "specifications", ["mkt_chn_data_id"], name: "index_specifications_on_mkt_chn_data_id", using: :btree
